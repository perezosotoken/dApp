...
import StakingRewardsArtifactV4 from "../core/StakingRewardsV4.json";
  ...
  useEffect(() => {
    ...
    const calculateAPR = async () => {
      if (stakingContractBalance) {
        const _tokenPrice = 0.002;
        // const priceUSD =   0.0000000022;
            ...
            <Box className="row justify-content-center">
              <Box className="col-12 col-md-7">
                <Box className="card no-hover staking-card single-staking">
                  <h3 className="m-0">
                    {!ctx.isSpanishCountry ? "Baby Perezoso Farming" : "Acuña tu token Perezoso y recibe Baby Perezoso"}</h3>
